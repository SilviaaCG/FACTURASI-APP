...
public class Main {
    ...
    factura1.setNumPago(ModoPago.EFECTIVO);

    Factura factura2 = new Factura();
    factura2.setFechaCreacion(new Timestamp(System.currentTimeMillis()));
    factura2.setNumPago(ModoPago.TARJETA_CREDITO);
    ...
    //AGREGANDO CLIENTE A FACTURAS
        ...
        producto1.setCategoria(Categoria.MEMORIA_RAM);
        Producto producto2 = new Producto();
        producto2.setNombre("Procesador Intel9 10343");
        producto2.setStock(20);
        producto2.setPrecio(400.0);
        producto2.setCategoria(Categoria.CABLES);
